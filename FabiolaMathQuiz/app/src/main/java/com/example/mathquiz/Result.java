...
import com.example.mathquiz.model.Score;
...
public class Result extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    private void scorePercentage(){
        ...
        // (rightAnswerCount / totalNumberOfQuestions) * 100
        int percentage = (int) Math.round((rightAnswerCount/listOfScores.size())*100);
